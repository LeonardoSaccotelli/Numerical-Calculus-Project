# -*- coding: utf-8 -*-
"""
Created on Wed Mar 25 21:46:33 2020

@author: Leonardo Saccotelli
 
 Test metodo di Jacobi
        --------------------------------------------------------------
...
#partiamo da una matrice di 100 fino ad una matrice di 2000 al passo di 200
n_matrix = range(100, 600, 200)
...
for n in n_matrix:
    ...
    for r in range(iteration):
        #Eseguo Jacobi
        x_find, k = AL.Jacobi(matrix, b, x0, eps, k_max)
