# -*- coding: utf-8 -*-
"""
Created on Fri Mar 13 01:49:07 2020

@author: leona
"""

# In questo software vogliamo studiare il condizionamento di alcune funzioni elementari.
# Studieremo la funzione f (x) = x^(4/5)*(10-x)^(1/5); prima di tutto studieremo la funzione
...
def createFunction(xArray):
    ...
    for i in range(len(xArray)):
        function[i] =(math.pow(x[i],4/5)*math.pow((10-x[i]),1/5))
...
x = np.linspace(1,10-1.0e-14 ,100)
