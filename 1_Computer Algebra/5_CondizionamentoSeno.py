...
# Studieremo la funzione f (x) = sin (x); prima di tutto studieremo la funzione
# sin (x) in un intervallo di valori; inseriremo una perturbazione e perturberemo
# l'intervallo di punti in cui stiamo studiando la funzione.
# Calcoleremo il seno ogni punto x perturbato.
# Alla fine studieremo l'errore verificatosi nella funzione sin (x) quando l'abbiamo calcolato
...
#Calcolo il seno in ogni punto di x peturbato
